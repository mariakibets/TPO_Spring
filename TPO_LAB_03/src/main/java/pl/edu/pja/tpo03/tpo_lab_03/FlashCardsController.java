...
import pl.edu.pja.tpo03.tpo_lab_03.profiles.Display;
import pl.edu.pja.tpo03.tpo_lab_03.service.EntryService;
...
public class FlashCardsController {
    ...
    public void sortWords() {
        ...
        List<Entry> sortedEntries = entryService.sortEntriesByLanguage(language, order.equalsIgnoreCase("asc"));
    ...
    public void searchWord() {
        ...
        List<Entry> foundEntries = entryService.searchEntries(word);
